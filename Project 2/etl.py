...
def process_song_file(cur, filepath):
    ...
    Process a single song file and insert data into the songs and artists tables.
        ...
        Parameters:
            ...
            filepath (str): The file path of the song file.
...
def process_log_file(cur, filepath):
    ...
    Process a single log file and insert data into the time, users, and songplays tables.
        ...
        Parameters:
            cur (cursor): The database cursor.
            filepath (str): The file path of the log file.
...
def process_data(cur, conn, filepath, func):
    """
    Process json files in a given directory.

        Parameters:
            cur (cursor): The database cursor.
            conn (connection): The database connection.
            filepath (str): The directory path containing the data files.
            func (function): The function to be applied to each data file.
